...
% phase and amygdala amplitude. Supplementary Fig.11,13 
...
for s=1:size(eR_hc,2)
  ...
  [mi,meanamp1] = ModIndex_v2_ft(heR,aeR,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  [mi,meanamp2] = ModIndex_v2_ft(heKF,aeKF,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  [mi,meanamp3] = ModIndex_v2_ft(hnR,anR,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  [mi,meanamp4] = ModIndex_v2_ft(hnKF,anKF,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  he = squeeze(he.trial);
  [mi,meanamp5] = ModIndex_v2_ft(he,ae,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  hn = squeeze(hn.trial);
  [mi,meanamp6] = ModIndex_v2_ft(hn,an,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  hr = squeeze(hr.trial);
  [mi,meanamp7] = ModIndex_v2_ft(hr,ar,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  hf = squeeze(hf.trial);
  [mi,meanamp8] = ModIndex_v2_ft(hf,af,srate,flow,flow_bw,fhigh,fhigh_bw,position);
