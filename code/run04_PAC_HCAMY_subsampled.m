% This script computes the phase to amplitude coupling (PAC) between hippocampus
% phase and amgydala amplitude controlling the number of trials. Supplementary Fig.11,13 
...
for s=1:size(eR_hc,2)
  ...
  [mi,meanamp1] = ModIndex_v2_ft_subsamp(heR,aeR,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  [mi,meanamp2] = ModIndex_v2_ft_subsamp(heKF,aeKF,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  [mi,meanamp3] = ModIndex_v2_ft_subsamp(hnR,anR,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  [mi,meanamp4] = ModIndex_v2_ft_subsamp(hnKF,anKF,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  he = squeeze(he.trial);
  [mi,meanamp5] = ModIndex_v2_ft_subsamp(he,ae,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  hn = squeeze(hn.trial);
  [mi,meanamp6] = ModIndex_v2_ft_subsamp(hn,an,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  hr = squeeze(hr.trial);
  [mi,meanamp7] = ModIndex_v2_ft_subsamp(hr,ar,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  hf = squeeze(hf.trial);
  [mi,meanamp8] = ModIndex_v2_ft_subsamp(hf,af,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
...
xlabel('HC Phase (Hz)','FontSize',10);
ylabel('AMY Amplitude (Hz)','FontSize',10);
h = colorbar;
h.FontSize = 8;
ylabel(h, 'MI')
...
h=get(gca);
ylim([0 1.8e-3]);
ylabel('Modulation Index');title('low\gamma_A_M_Y - \theta_H_C');
...
h=get(gca);
ylim([0 1.8e-3]);
title('high\gamma_A_M_Y - \theta_H_C');
