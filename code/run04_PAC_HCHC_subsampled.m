...
% hippocampus contacts controlling the number of trials. Supplementary Fig. 12, 14
...
for s=1:size(eR_hc,2)
  ...
  [mi,meanamp1] = ModIndex_v2_ft_subsamp(heR,heR,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  [mi,meanamp2] = ModIndex_v2_ft_subsamp(heKF,heKF,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  [mi,meanamp3] = ModIndex_v2_ft_subsamp(hnR,hnR,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  [mi,meanamp4] = ModIndex_v2_ft_subsamp(hnKF,hnKF,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  he = squeeze(he.trial);
  [mi,meanamp5] = ModIndex_v2_ft_subsamp(he,he,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  hn = squeeze(hn.trial);
  [mi,meanamp6] = ModIndex_v2_ft_subsamp(hn,hn,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  hr = squeeze(hr.trial);
  [mi,meanamp7] = ModIndex_v2_ft_subsamp(hr,hr,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  hf = squeeze(hf.trial);
  [mi,meanamp8] = ModIndex_v2_ft_subsamp(hf,hf,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
...
h=get(gca);
ylim([0 1.8e-3]);
ylabel('Modulation Index');title('low\gamma_H_C - \theta_H_C');
