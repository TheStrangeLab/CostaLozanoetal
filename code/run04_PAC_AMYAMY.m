...
% amygdala contacts. Supplementary Fig. 12, 14
...
for s=1:size(eR_amy,2)
  ...
  [mi,meanamp1] = ModIndex_v2_ft(aeR,aeR,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  [mi,meanamp2] = ModIndex_v2_ft(aeKF,aeKF,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  [mi,meanamp3] = ModIndex_v2_ft(anR,anR,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  [mi,meanamp4] = ModIndex_v2_ft(anKF,anKF,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  [mi,meanamp5] = ModIndex_v2_ft(ae,ae,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  [mi,meanamp6] = ModIndex_v2_ft(an,an,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  [mi,meanamp7] = ModIndex_v2_ft(ar,ar,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  [mi,meanamp8] = ModIndex_v2_ft(af,af,srate,flow,flow_bw,fhigh,fhigh_bw,position);
