...
% phase and hippocampus amplitud. Fig 2d, Supplementary Fig.11,13 
...
for s=1:size(eR_hc,2)
  ...
  [mi,meanamp3] = ModIndex_v2_ft(anR,hnR,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  [mi,meanamp4] = ModIndex_v2_ft(anKF,hnKF,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  he = squeeze(he.trial);
  [mi,meanamp5] = ModIndex_v2_ft(ae,he,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  hn = squeeze(hn.trial);
  [mi,meanamp6] = ModIndex_v2_ft(an,hn,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  hr = squeeze(hr.trial);
  [mi,meanamp7] = ModIndex_v2_ft(ar,hr,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  hf = squeeze(hf.trial);
  [mi,meanamp8] = ModIndex_v2_ft(af,hf,srate,flow,flow_bw,fhigh,fhigh_bw,position);
...
% print(fullfile(pathfigs,'TortAMYHC_foi_scatter_emotion_main_8-9patients_hccluster.jpg'),'-djpeg');
