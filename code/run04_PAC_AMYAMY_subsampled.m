% This script computes the phase to amplitude coupling (PAC) within the
% amygdala contacts controlling the number of trials. Supplementary Fig. 12, 14
...
for s=1:size(eR_amy,2)
  aeR = raw2data(eR_amy{1,s},'rpt_chan_time');
  aeR = squeeze(aeR.trial);
  [mi,meanamp1] = ModIndex_v2_ft_subsamp(aeR,aeR,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  [mi,meanamp2] = ModIndex_v2_ft_subsamp(aeKF,aeKF,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  [mi,meanamp3] = ModIndex_v2_ft_subsamp(anR,anR,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  [mi,meanamp4] = ModIndex_v2_ft_subsamp(anKF,anKF,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  [mi,meanamp5] = ModIndex_v2_ft_subsamp(ae,ae,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  [mi,meanamp6] = ModIndex_v2_ft_subsamp(an,an,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  [mi,meanamp7] = ModIndex_v2_ft_subsamp(ar,ar,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
  ...
  [mi,meanamp8] = ModIndex_v2_ft_subsamp(af,af,srate,flow,flow_bw,fhigh,fhigh_bw,position,min(trials(s,:)),nresamp);
...
h=get(gca);
ylim([0 4e-3]);
ylabel('Modulation Index');title('low\gamma_A_M_Y - \theta_A_M_Y');
...
h=get(gca);
ylim([0 4e-3]);
title('high\gamma_A_M_Y - \theta_A_M_Y');
