...
% hippocampus contacts. Supplementary Fig. 12, 14
...
for s=1:size(eR_hc,2)
  ...
  [mi,meanamp1] = ModIndex_v2_ft(heR,heR,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  [mi,meanamp2] = ModIndex_v2_ft(heKF,heKF,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  [mi,meanamp3] = ModIndex_v2_ft(hnR,hnR,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  [mi,meanamp4] = ModIndex_v2_ft(hnKF,hnKF,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  he = squeeze(he.trial);
  [mi,meanamp5] = ModIndex_v2_ft(he,he,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  hn = squeeze(hn.trial);
  [mi,meanamp6] = ModIndex_v2_ft(hn,hn,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  hr = squeeze(hr.trial);
  [mi,meanamp7] = ModIndex_v2_ft(hr,hr,srate,flow,flow_bw,fhigh,fhigh_bw,position);
  ...
  hf = squeeze(hf.trial);
  [mi,meanamp8] = ModIndex_v2_ft(hf,hf,srate,flow,flow_bw,fhigh,fhigh_bw,position);
